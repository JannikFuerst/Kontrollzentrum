...
15. [Versionierung auf 3.6.0](#versionierung-auf-360)
...
## Versionierung auf 3.6.0

Fuer dieses Release wurde die Version konsistent auf `3.6.0` angehoben.
...
Fuer den GitHub-Release-Workflow sollte das Tag als `v3.6.0` gepusht werden, weil genau dieses Format den Release-Workflow startet.
