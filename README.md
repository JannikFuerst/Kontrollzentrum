...
15. [Versionierung auf 3.6.1](#versionierung-auf-361)
...
## Versionierung auf 3.6.1

Fuer dieses Release wurde die Version konsistent auf `3.6.1` angehoben.
...
Fuer den GitHub-Release-Workflow sollte das Tag als `v3.6.1` gepusht werden, weil genau dieses Format den Release-Workflow startet.
