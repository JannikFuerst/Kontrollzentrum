...
15. [Versionierung auf 3.6.2](#versionierung-auf-362)
...
## Versionierung auf 3.6.2

Fuer dieses Release wurde die Version konsistent auf `3.6.2` angehoben.
...
Fuer den GitHub-Release-Workflow sollte das Tag als `v3.6.2` gepusht werden, weil genau dieses Format den Release-Workflow startet.
